...
Release público atual: **21.12.409**, pareado ao APK **v700 / 2026.08.22.01** (SOURCE `40151107574b0adb`, BUILD `e2b8a71b7208c9d0`).
...
- APK pareado: `2026.08.22.01` (v700 — v700 — Evidência de release reproduzível).
- APK mínimo aceito: `2026.07.30.01` (v569, versão instalada anterior ao hotfix).
- APK máximo homologado: `2026.08.22.01`.
