-- VALORAE 2026-07-26 — sincronização financeira mínima v2
-- Mantém no Supabase apenas o necessário para a conta do usuário:
--   1) histórico de transações;
--   2) histórico/agenda de dividendos;
-- Não há snapshots, cache, monitor, backups, dispositivos nem tabela de estado.
--
-- Este script NÃO apaga as tabelas antigas. Ele migra os dados válidos para tabelas novas,
-- desativa as RPCs antigas para o service_role e deixa o legado disponível como backup de transição.
