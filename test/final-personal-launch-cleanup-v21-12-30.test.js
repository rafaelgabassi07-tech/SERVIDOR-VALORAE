...
assert.match(VALORAE_SERVER_METRICS_VERSION, /^21\.12\.(30|32)-/);
...
assert.match(snap.version, /^21\.12\.(30|32)-/);
...
assert.ok(/21\.12\.(30|32)/.test(integration.json.contractVersion));
