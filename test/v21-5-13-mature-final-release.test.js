...
{
  const payload = { version: '21.12.0', ticker: 'PETR4', results: { dy: '8%' } };
...
{
  const payload = { version: '21.12.0', requestId: 'r1', ticker: 'PETR4', results: { dy: '8%' } };
...
console.log('v21.12.0 mature final release tests OK.');
