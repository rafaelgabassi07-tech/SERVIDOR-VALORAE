...
{
  const payload = { version: '21.11.8', ticker: 'PETR4', results: { dy: '8%' } };
...
{
  const payload = { version: '21.11.8', requestId: 'r1', ticker: 'PETR4', results: { dy: '8%' } };
...
console.log('v21.11.8 mature final release tests OK.');
