...
assert.equal(packageJson.valorae.publicVersion, '21.12.398');
assert.equal(packageJson.valorae.releasePatch, '21.12.398-ecosystem-performance-hardening-v366');
...
assert.equal(packageJson.valorae.monitorVersion, 'static-no-api-v400');
