...
assert.equal(packageJson.valorae.publicVersion, '21.12.365');
assert.equal(packageJson.valorae.releasePatch, '21.12.365-return-index-provider-parity-v333');
assert.equal(metadata.apkVersion, '2026.07.13.09');
assert.ok(metadata.contractVersion.includes('APK v513 / Proxy 21.12.365'));
