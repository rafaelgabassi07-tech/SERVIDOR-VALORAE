...
assert.equal(packageJson.valorae.publicVersion, '21.12.405');
assert.equal(packageJson.valorae.releasePatch, '21.12.405-market-session-hygiene-v414');
...
assert.equal(packageJson.valorae.monitorVersion, 'vertical-flow-v407');
