...
assert.equal(packageJson.valorae.publicVersion, '21.12.391');
assert.equal(packageJson.valorae.releasePatch, '21.12.391-analysis-change-monitor-v359');
assert.equal(metadata.apkVersion, '2026.07.23.02');
assert.ok(metadata.contractVersion.includes('APK v531 / Proxy 21.12.391'));
...
assert.equal(correlatedRes.getHeader('Access-Control-Allow-Origin'), '*');
