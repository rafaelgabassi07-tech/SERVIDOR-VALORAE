...
assert.match(history, /PORTFOLIO_HISTORY_VERSION = '21.12.353-asset-modal-required-sections-hardening-v321'/,
  'motor deve expor versão atual v317 mantendo o engine v292');
