...
assert.match(history, /PORTFOLIO_HISTORY_VERSION = '21\.12\.326-full-modal-portfolio-history-alignment-v297'/,
  'motor deve expor versão atual v297 mantendo o engine v292');
