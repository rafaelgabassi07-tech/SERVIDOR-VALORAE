...
for (const required of ['api/index.js','api/[...path].js','api/server/metrics.js','api/server/tests.js','api/cache/stats.js','api/source/status.js','api/ready.js','api/deploy/status.js']) assert.ok(m.physicalFunctions.includes(required), `manifest sem ${required}`);
...
console.log('v21.11.8 launch readiness tests OK.');
