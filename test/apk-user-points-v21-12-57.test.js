...
assert.match(pkg.valorae.releasePatch, /^21\.12\.\d+-.+$/, 'releasePatch deve acompanhar a release atual sem travar testes em patches antigos.');
...
console.log('apk-user-points-current-release OK');
