...
assert.match(html, /21\.12\.(54-total-apk-proxy-contract|56-full-audit-benchmark-apk-compat|57-user-points-apk-compat)/, 'release atual deve estar exposta');
...
assert.match(manifest, /21\.12\.(54|56|57)/, 'manifest PWA deve expor a release atual');
assert.match(sw, /valorae-proxy-server-v21-12-(54|56|57)/, 'service worker deve usar cache novo da release atual');
