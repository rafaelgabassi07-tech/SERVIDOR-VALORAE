...
assert.match(manifest, /21\.12\.(54|56|57|58)/, 'manifest PWA deve expor a release atual');
assert.match(sw, /valorae-proxy-server-v21-12-(54|56|57|58)/, 'service worker deve usar cache novo da release atual');
