...
try {
  ...
  assert.equal(payload.dataReliability.version, '21.12.49-extreme-audit-logo-standard');
  ...
  assert.match(payload.extractionCompleteness.canonicalReliability.version, /21\.12\.(48|49)/);
