...
assert.ok(source.includes('fetchInvestidor10StockBundle(ticker, Math.min(timeoutMs, fastMode ? 3200 : 7000), { mode: stage })'), 'stock modal must cap Investidor10 bundle differently for fast/full stages');
