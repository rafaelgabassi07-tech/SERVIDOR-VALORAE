...
assert.ok(source.includes('const stockBundlePromise = fetchInvestidor10StockBundle(') && source.includes('Math.min(timeoutMs, fastMode ? 3200 : 7000)'), 'stock modal must cap Investidor10 bundle differently for fast/full stages');
