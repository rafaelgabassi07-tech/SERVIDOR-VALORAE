...
assert.match(manifest.version, /^21\.12\.(31|32)$/);
assert.equal(manifest.start_url, '/server.html#command');

const sw = fs.readFileSync('public/service-worker.js', 'utf8');
assert.ok(sw.includes('v21-12-31') || sw.includes('v21-12-32'), 'service worker deve usar cache novo do redesign/performance');
...
assert.ok(readme.includes('v21.12.31') && readme.includes('v21.12.32'));
