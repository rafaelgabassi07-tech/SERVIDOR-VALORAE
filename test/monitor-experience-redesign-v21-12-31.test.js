...
assert.match(manifest.version, /^21\.12\.(31|32|35)$/);
assert.equal(manifest.start_url, '/server.html#command');

const sw = fs.readFileSync('public/service-worker.js', 'utf8');
assert.ok(sw.includes('v21-12-31') || sw.includes('v21-12-32') || sw.includes('v21-12-35'), 'service worker deve usar cache novo do redesign/performance');
