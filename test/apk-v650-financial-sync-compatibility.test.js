...
assert.equal(evaluateApkCompatibility('2026.08.11.06', { allowFuture: false }).status, 'PAIRED');
assert.equal(evaluateApkCompatibility('2026.08.11.06', { allowFuture: false }).reject, false);
