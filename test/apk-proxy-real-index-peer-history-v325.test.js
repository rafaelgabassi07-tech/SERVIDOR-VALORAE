...
assert.ok(['2026.07.13.01', '2026.07.13.02', '2026.07.13.03', '2026.07.13.04', '2026.07.13.07', '2026.07.13.08', '2026.07.14.02', '2026.07.14.04', '2026.07.15.04', '2026.07.15.05', '2026.07.15.06', '2026.07.15.07', '2026.07.23.03', '2026.07.23.05'].includes(metadata.apkVersion));
...
if (returnsUi && readiness && merge && quality && build) {
  ...
  assert.match(build, /versionCode = 2607(?:130[1-9]|140[1-5]|150[1-8]|1601|170[12]|230[1-5])/);
  assert.match(build, /versionName = "2026\.07\.(?:13\.0[1-9]|14\.0[1-5]|15\.0[1-8]|16\.01|17\.0[12]|23\.0[1-5])"/);
}
