...
assert.equal(APK_COMPATIBILITY.maxTestedVersion, '2026.08.07.12');
...
await dispatchRoute({
  ...
  headers: {
    ...
    'x-valorae-app-version': '2026.08.07.12',
...
assert.equal(payload.apkCompatibility.pairedVersion, '2026.08.07.12');
