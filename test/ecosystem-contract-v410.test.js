...
assert.equal(APK_COMPATIBILITY.maxTestedVersion, '2026.08.08.11');
...
await dispatchRoute({
  ...
  headers: {
    ...
    'x-valorae-app-version': '2026.08.08.11',
...
assert.equal(payload.apkCompatibility.pairedVersion, '2026.08.08.11');
