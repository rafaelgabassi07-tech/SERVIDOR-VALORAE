...
assert.equal(APK_COMPATIBILITY.maxTestedVersion, '2026.08.05.04');
...
await dispatchRoute({
  ...
  headers: {
    ...
    'x-valorae-app-version': '2026.08.05.04',
...
assert.equal(payload.apkCompatibility.pairedVersion, '2026.08.05.04');
