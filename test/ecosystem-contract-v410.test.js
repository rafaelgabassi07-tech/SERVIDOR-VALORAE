...
const EXPECTED = 'valorae-ecosystem-2026.08.05.03-p403';
...
assert.equal(APK_COMPATIBILITY.maxTestedVersion, '2026.08.05.03');
...
assert.equal(payload.apkCompatibility.pairedVersion, '2026.08.05.03');
