...
const expectedFingerprint = 'a1d14e55b56f862c';
const expectedPatch = '21.12.408-cache-runtime-alignment-v421';
const expectedLabel = 'cache-runtime-alignment-v421';
...
console.log(`apk-v671-cache-alignment-v421 ok: ${apkCanonicalRoutes.length} rotas + cache/fingerprint alinhados`);
