...
clearCache();
assert.equal(ASSET_MODAL_RUNTIME_VERSION, '26.asset-modal.runtime.v5-full-only');
assert.notEqual(
...
assert.equal(first.diagnostics.modalRuntime.version, '26.asset-modal.runtime.v5-full-only');
