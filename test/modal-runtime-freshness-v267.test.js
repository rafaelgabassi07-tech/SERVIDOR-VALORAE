...
clearCache();
assert.equal(ASSET_MODAL_RUNTIME_VERSION, '26.asset-modal.runtime.v4-deadline');
assert.notEqual(
...
assert.equal(first.diagnostics.modalRuntime.version, '26.asset-modal.runtime.v4-deadline');
