...
assert.equal(info.facts.find(item => item.id === 'market_value').detailedValue, '');
...
assert.equal(info.facts.find(item => item.id === 'shares_total').detailedValue, '');
...
assert.equal(parsed.detailedValue, '');
