...
assert.ok(['21.12.358', '21.12.359', '21.12.360', '21.12.364', '21.12.367', '21.12.369', '21.12.373', '21.12.374', '21.12.375', '21.12.376', '21.12.380', '21.12.382', '21.12.390', '21.12.396', '21.12.397', '21.12.398', '21.12.400'].includes(pkg.valorae.publicVersion));
assert.ok(['21.12.358-modal-data-truth-audit-v326', '21.12.359-modal-source-arrival-integrity-v327', '21.12.360-news-logos-chart-tooltips-v328', '21.12.364-monthly-variation-logos-return-indices-v332', '21.12.367-logo-source-performance-v335', '21.12.369-field-observability-v337', '21.12.373-dynamic-render-fallback-v341', '21.12.374-formal-schema-validation-v342', '21.12.375-http-provider-transport-v343', '21.12.376-shared-runtime-state-v344', '21.12.380-scraping-runtime-hardening-v348', '21.12.382-quote-state-resilience-v350', '21.12.390-financial-sync-integrity-v358', '21.12.396-asset-modal-completeness-v364', '21.12.397-financial-integrity-audit-v365', '21.12.398-ecosystem-performance-hardening-v366', '21.12.400-cloud-transaction-recovery-v368'].includes(pkg.valorae.releasePatch));
if (metadata.apkVersion) assert.match(metadata.apkVersion, /^2026\.(?:07\.(?:13|14|15|16|17|23|24|25|26|27|30)|08\.04)\.\d{2}$/);
