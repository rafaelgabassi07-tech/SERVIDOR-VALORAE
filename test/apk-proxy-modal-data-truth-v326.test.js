...
assert.ok(['21.12.358', '21.12.359', '21.12.360', '21.12.364', '21.12.367', '21.12.369', '21.12.373', '21.12.374', '21.12.375', '21.12.376', '21.12.380', '21.12.381'].includes(pkg.valorae.publicVersion));
...
assert.ok(['2026.07.13.02', '2026.07.13.03', '2026.07.13.04', '2026.07.13.07', '2026.07.13.08', '2026.07.14.02', '2026.07.14.04', '2026.07.15.04', '2026.07.15.05', '2026.07.15.06', '2026.07.15.07', '2026.07.17.01'].includes(metadata.apkVersion));
assert.match(metadata.contractVersion, /APK v(?:50[6-9]|51[0-9]|52[0-8]) \/ Proxy 21\.12\.(?:35[89]|36[0-9]|37[0-9]|380|381)/);
...
if ([models, parser, fiiParser, checklistUi, vacancyUi, build].every(Boolean)) {
  ...
  assert.match(build, /versionCode = 2607(?:130[2-9]|140[1-5]|150[1-8]|1601|1701)/);
  assert.match(build, /versionName = "2026\.07\.(?:13\.0[2-9]|14\.0[1-5]|15\.0[1-8]|16\.01|17\.01)"/);
}
