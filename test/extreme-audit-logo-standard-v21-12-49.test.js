...
assert.match(html, /21\.12\.49-extreme-audit-logo-standard/, 'release v21.12.49 deve estar exposta');
...
assert.match(manifest, /21\.12\.49/, 'manifest PWA deve expor v21.12.49');
assert.match(sw, /valorae-proxy-server-v21-12-49/, 'service worker deve usar cache novo v21.12.49');
