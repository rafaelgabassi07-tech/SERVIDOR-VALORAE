...
assert.match(manifest, /21\.12\.(49|56|57|58|58)/, 'manifest PWA deve expor a release atual ou legado v21.12.49');
assert.match(sw, /valorae-proxy-server-v21-12-(49|56|57|58|58)/, 'service worker deve usar cache de release atual');
