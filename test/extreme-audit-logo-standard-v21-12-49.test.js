...
assert.match(html, /21\.12\.(49-extreme-audit-logo-standard|56-full-audit-benchmark-apk-compat)/, 'release atual ou marcador legado v21.12.49 deve estar exposta');
...
assert.match(manifest, /21\.12\.(49|56)/, 'manifest PWA deve expor a release atual ou legado v21.12.49');
assert.match(sw, /valorae-proxy-server-v21-12-(49|56)/, 'service worker deve usar cache de release atual');
