...
if (!build) {
  console.log('apk-v699-android16-api36-v426 skipped: execute npm run test:cross-stack para validar o APK pareado');
  process.exit(0);
}
...
assert.equal(versionCode, 26082107);
assert.equal(versionName, '2026.08.21.07');
assert.equal(checkpoint, 'v699-android16-api36-hardening');
...
console.log(`apk-v699-android16-api36-v426 ok: APK ${versionName}/${sourceFingerprint}/${buildFingerprint} ↔ Proxy ${RELEASE.publicVersion}; ${expectedRoutes.length} rotas auditadas`);
