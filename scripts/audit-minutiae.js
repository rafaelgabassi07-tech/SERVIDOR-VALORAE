...
assert(pkg.version === '21.12.0', 'package.json deve estar na versão 21.12.0.');
assert(read('lib/Valorae-engine.js').includes('21.12.0'), 'Engine deve expor versão 21.12.0.');
assert(read('public/index.html').includes('21.12.0'), 'public/index.html deve exibir versão 21.12.0.');
assert(read('routes/ready.js').includes("const version = '21.12.0'"), 'ready.js deve declarar release 21.12.0.');
assert(read('routes/manifest.js').includes("release: '21.12.0'"), 'manifest.js deve declarar release 21.12.0.');
...
assert(manifest.physicalFunctions.length === 1 && manifest.physicalFunctions.includes('api/router.js'), 'manifest deve manter Function física única api/router.js para Vercel Free.');
