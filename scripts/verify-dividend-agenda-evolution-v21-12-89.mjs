...
const checks = [
  ['release 21.12.89', release.includes("VALORAE_PUBLIC_VERSION = '21.12.89'")],
...
if (failed.length) {
  console.error(`VALORAE Proxy agenda/evolução v21.12.89 FAILED: ${failed.map(([n]) => n).join(', ')}`);
  process.exit(1);
}
console.log('VALORAE Proxy agenda/evolução v21.12.89 OK');
