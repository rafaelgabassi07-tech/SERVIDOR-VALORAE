...
const allowed = new Set(['api/index.js','api/[...path].js','api/server/metrics.js','api/v1/server/metrics.js','api/v2/server/metrics.js','api/ready.js','api/v1/ready.js','api/v2/ready.js','api/deploy/status.js']);
const found = [];
function walk(dir) {
