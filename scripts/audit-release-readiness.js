...
console.log(`Release readiness OK: ${pkg.version}, ${manifest.routes.length} rotas internas, ${manifest.physicalFunctions.length} Functions físicas consolidadas, sem dependências obrigatórias.`);
