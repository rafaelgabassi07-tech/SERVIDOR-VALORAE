...
const expectedPublic = '21.12.350';
const expectedPatch = '21.12.350-full-audit-integration-hardening-v318';
...
assert.ok(sw.includes('v21-12-350'));
assert.ok(coreRelease.includes(expectedPatch));
assert.ok(coreRelease.includes('valorae-proxy-server-v21-12-350'));
assert.ok(currentRelease.includes("VALORAE_PUBLIC_VERSION = '21.12.350'"));
