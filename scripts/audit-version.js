...
const expectedPublic = '21.12.357';
const expectedPatch = '21.12.357-real-indices-peer-patrimony-history-v325';
...
assert.ok(sw.includes('v21-12-357'));
assert.ok(coreRelease.includes(expectedPatch));
assert.ok(coreRelease.includes('valorae-proxy-server-v21-12-357'));
assert.ok(currentRelease.includes("VALORAE_PUBLIC_VERSION = '21.12.357'"));
