...
const expectedPublic = '21.12.358';
const expectedPatch = '21.12.358-modal-data-truth-audit-v326';
...
assert.ok(sw.includes('v21-12-358'));
assert.ok(coreRelease.includes(expectedPatch));
assert.ok(coreRelease.includes('valorae-proxy-server-v21-12-358'));
assert.ok(currentRelease.includes("VALORAE_PUBLIC_VERSION = '21.12.358'"));
