...
const expectedPublic = '21.12.351';
const expectedPatch = '21.12.351-asset-modal-section-complete-recovery-v319';
...
assert.ok(sw.includes('v21-12-351'));
assert.ok(coreRelease.includes(expectedPatch));
assert.ok(coreRelease.includes('valorae-proxy-server-v21-12-351'));
assert.ok(currentRelease.includes("VALORAE_PUBLIC_VERSION = '21.12.351'"));
