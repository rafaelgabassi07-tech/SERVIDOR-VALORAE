...
const expectedPublic = '21.12.337';
const expectedPatch = '21.12.337-asset-modal-fast-cache-context-v305';
...
assert.ok(sw.includes('v21-12-337'));
assert.ok(coreRelease.includes(expectedPatch));
assert.ok(coreRelease.includes('valorae-proxy-server-v21-12-337'));
assert.ok(currentRelease.includes("VALORAE_PUBLIC_VERSION = '21.12.337'"));
