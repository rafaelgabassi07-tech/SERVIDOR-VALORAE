...
const expectedPublic = '21.12.354';
const expectedPatch = '21.12.354-asset-modal-late-arrival-settlement-v322';
...
assert.ok(sw.includes('v21-12-354'));
assert.ok(coreRelease.includes(expectedPatch));
assert.ok(coreRelease.includes('valorae-proxy-server-v21-12-354'));
assert.ok(currentRelease.includes("VALORAE_PUBLIC_VERSION = '21.12.354'"));
