...
const expectedPublic = '21.12.338';
const expectedPatch = '21.12.338-asset-modal-late-producer-quality-v306';
...
assert.ok(sw.includes('v21-12-338'));
assert.ok(coreRelease.includes(expectedPatch));
assert.ok(coreRelease.includes('valorae-proxy-server-v21-12-338'));
assert.ok(currentRelease.includes("VALORAE_PUBLIC_VERSION = '21.12.338'"));
