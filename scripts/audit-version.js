...
const expectedPublic = '21.12.353';
const expectedPatch = '21.12.353-asset-modal-required-sections-hardening-v321';
...
assert.ok(sw.includes('v21-12-353'));
assert.ok(coreRelease.includes(expectedPatch));
assert.ok(coreRelease.includes('valorae-proxy-server-v21-12-353'));
assert.ok(currentRelease.includes("VALORAE_PUBLIC_VERSION = '21.12.353'"));
