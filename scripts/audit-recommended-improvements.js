...
assert(pkg.version === '21.11.6', 'package.json precisa estar em 21.11.6.');
...
console.log('Recommended improvements audit OK: melhorias viáveis v21.11.6 presentes e sem tecnologias não recomendadas.');
