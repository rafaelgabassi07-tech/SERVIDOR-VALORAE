...
assert(pkg.version === '21.12.0', 'package.json precisa estar em 21.12.0.');
assert(Object.keys(pkg.dependencies || {}).length === 0, 'dependencies deve continuar vazio.');
assert(manifest.physicalFunctions.length === 1 && manifest.physicalFunctions.includes('api/router.js'), 'Functions físicas devem ficar consolidadas em api/router.js para Vercel Free.');
...
console.log('Recommended improvements audit OK: melhorias viáveis v21.12.0 presentes e sem tecnologias não recomendadas.');
