...
- Atualização do cache PWA para `valorae-proxy-server-v21-12-39`, evitando que navegador mantenha shell antigo da v21.12.37.
...
- Preservação do contrato público `package.version = 21.12.0`; o patch interno fica em `releasePatch = 21.12.39-full-project-audit-hardening`.
