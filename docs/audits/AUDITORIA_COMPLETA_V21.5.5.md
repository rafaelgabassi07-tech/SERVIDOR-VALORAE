# Valorae v21.11.8 — Auditoria Completa e Hardening Free
...
A v21.11.8 mantém o projeto como proxy gratuito para GitHub/Vercel e melhora a previsibilidade operacional sem quebrar o núcleo `lib/Valorae-engine.js`.
