# Valorae v21.12.0 — Auditoria Completa e Hardening Free
...
A v21.12.0 mantém o projeto como proxy gratuito para GitHub/Vercel e melhora a previsibilidade operacional sem quebrar o núcleo `lib/Valorae-engine.js`.
