# Valorae v21.11.4 — Auditoria Completa e Hardening Free
...
A v21.11.4 mantém o projeto como proxy gratuito para GitHub/Vercel e melhora a previsibilidade operacional sem quebrar o núcleo `lib/Valorae-engine.js`.
