# Valorae v21.11.6 — Revisão Final e Correções Free-only
...
3. OpenAPI deixou de carregar texto antigo de auditoria v20.8 e passa a declarar a revisão v21.11.6.
