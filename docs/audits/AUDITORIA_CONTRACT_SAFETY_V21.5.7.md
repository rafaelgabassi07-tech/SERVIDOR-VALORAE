# Auditoria v21.11.8 — Contract Safety Hardening Free

## Status

A v21.11.8 aplica a auditoria técnica da v21.5.6 e corrige pontos que ainda estavam documentados, mas não plenamente implementados.
...
- `npm run audit:version`: OK, versão 21.11.8.
