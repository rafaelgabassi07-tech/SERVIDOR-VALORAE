# Quality Matrix — Valorae v21.11.7

A v21.11.7 implementa somente melhorias recomendadas e viáveis:
...
- testes/auditorias: auditoria v21.11.7 para contrato, segurança e melhorias recomendadas.
