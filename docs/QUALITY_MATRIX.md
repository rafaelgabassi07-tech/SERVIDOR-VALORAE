# Quality Matrix — Valorae v21.11.8

A v21.11.8 implementa somente melhorias recomendadas e viáveis:
...
- testes/auditorias: auditoria v21.11.8 para contrato, segurança e melhorias recomendadas.
