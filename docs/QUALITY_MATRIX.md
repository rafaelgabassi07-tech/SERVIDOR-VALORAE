# Quality Matrix — Valorae v21.11.3

A v21.11.3 implementa somente melhorias recomendadas e viáveis:
...
- testes/auditorias: auditoria v21.11.3 para contrato, segurança e melhorias recomendadas.
