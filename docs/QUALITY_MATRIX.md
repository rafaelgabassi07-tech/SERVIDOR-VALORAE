# Quality Matrix — Valorae v21.11.4

A v21.11.4 implementa somente melhorias recomendadas e viáveis:
...
- testes/auditorias: auditoria v21.11.4 para contrato, segurança e melhorias recomendadas.
