...
## v21.11.6 — Vercel Entrypoint, Dashboard Server e Metrics Recovery
...
- Atualiza a versão do projeto para `21.11.6` em pacote, Engine, scripts, docs e validações para reduzir conflito entre painel/API.
...
## v21.11.6 — Vercel Build Safe Fix
...
## v21.11.6 — Engine Performance & Precision
...
## v21.11.6 — Mature Final Release Free
...
- Adiciona `npm run audit:final` e teste comportamental v21.11.6.
...
## v21.11.6 - Otimização profunda Scraper/API
