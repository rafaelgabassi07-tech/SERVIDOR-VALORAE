...
export const INVESTIDOR10_ANALYSIS_RANKINGS_VERSION = '21.12.404-analysis-rankings-semantic-v3';
...
const DEFINITIONS = Object.freeze({
  ...
  STOCK_REVENUE: Object.freeze({
    id: 'STOCK_REVENUE', assetType: 'ACAO', title: 'Maiores receitas',
    subtitle: 'Ações com maior receita reportada nos balanços mais recentes.',
    url: 'https://investidor10.com.br/acoes/rankings/maiores-receitas/',
    pageNeedles: ['maior receita', 'maiores receitas'],
    primaryKey: 'revenue', primaryLabel: 'Receita', primaryAliases: ['receita', 'receita liquida'],
    displayMetrics: ['revenue', 'netIncome', 'roe', 'netMargin', 'marketCap', 'price'],
  }),
  STOCK_NET_INCOME: Object.freeze({
    id: 'STOCK_NET_INCOME', assetType: 'ACAO', title: 'Maiores lucros',
    subtitle: 'Ações com maior lucro líquido reportado nos balanços mais recentes.',
    url: 'https://investidor10.com.br/acoes/rankings/maiores-lucros/',
    pageNeedles: ['maior lucro', 'maiores lucros'],
    primaryKey: 'netIncome', primaryLabel: 'Lucro', primaryAliases: ['lucro', 'lucro liquido'],
    displayMetrics: ['netIncome', 'revenue', 'roe', 'pl', 'netMargin', 'marketCap'],
  }),
  STOCK_ROE: Object.freeze({
    id: 'STOCK_ROE', assetType: 'ACAO', title: 'Maiores ROEs',
    subtitle: 'Ações com maior retorno sobre o patrimônio líquido.',
    url: 'https://investidor10.com.br/acoes/rankings/maiores-roes/',
    pageNeedles: ['maior roe', 'maiores roes'],
    primaryKey: 'roe', primaryLabel: 'ROE', primaryAliases: ['roe'],
    displayMetrics: ['roe', 'pl', 'netMargin', 'dividendYield', 'marketCap', 'price'],
  }),
  STOCK_PL_LOW: Object.freeze({
    id: 'STOCK_PL_LOW', assetType: 'ACAO', title: 'Menores P/L',
    subtitle: 'Ações com os menores múltiplos preço/lucro publicados.',
    url: 'https://investidor10.com.br/acoes/rankings/menores-pls/',
    pageNeedles: ['menor p/l', 'menores p/l', 'menores p/ls'],
    primaryKey: 'pl', primaryLabel: 'P/L', primaryAliases: ['p/l', 'p l'],
    displayMetrics: ['pl', 'roe', 'pvp', 'dividendYield', 'marketCap', 'price'],
  }),
  STOCK_30D_GAIN: Object.freeze({
    id: 'STOCK_30D_GAIN', assetType: 'ACAO', title: 'Maiores altas em 30 dias',
    subtitle: 'Ações com maior valorização acumulada nos últimos 30 dias.',
    url: 'https://investidor10.com.br/acoes/rankings/maiores-altas-30-dias/',
    pageNeedles: ['maior alta dos ultimos 30 dias', 'maiores altas 30 dias', 'maiores altas em 30 dias'],
    primaryKey: 'variation30d', primaryLabel: 'Variação 30d', primaryAliases: ['variacao 30d', 'variacao 30 dias'],
    displayMetrics: ['variation30d', 'variation12m', 'pl', 'dividendYield', 'marketCap', 'price'],
  }),
  STOCK_12M_GAIN: Object.freeze({
    id: 'STOCK_12M_GAIN', assetType: 'ACAO', title: 'Maiores altas em 12 meses',
    subtitle: 'Ações com maior valorização acumulada em 12 meses.',
    url: 'https://investidor10.com.br/acoes/rankings/maiores-altas-12-meses/',
    pageNeedles: ['maior alta em 12 meses', 'maiores altas 12 meses', 'maiores altas em 12 meses'],
    primaryKey: 'variation12m', primaryLabel: 'Variação 12M', primaryAliases: ['variacao 12m', 'variacao 12 meses'],
    displayMetrics: ['variation12m', 'variation30d', 'pl', 'dividendYield', 'marketCap', 'price'],
  }),
  STOCK_CASH: Object.freeze({
    id: 'STOCK_CASH', assetType: 'ACAO', title: 'Maiores caixas',
    subtitle: 'Ações de empresas com maior posição de caixa publicada.',
    url: 'https://investidor10.com.br/acoes/rankings/maiores-caixas/',
    pageNeedles: ['maior caixa', 'maiores caixa', 'maiores caixas'],
    primaryKey: 'cash', primaryLabel: 'Caixas', primaryAliases: ['caixas', 'caixa'],
    displayMetrics: ['cash', 'revenue', 'netIncome', 'pl', 'marketCap', 'price'],
  }),
  STOCK_PROFIT_GROWTH_5Y: Object.freeze({
    id: 'STOCK_PROFIT_GROWTH_5Y', assetType: 'ACAO', title: 'Maior crescimento de lucro',
    subtitle: 'Ações com maior crescimento de lucro no horizonte de 5 anos.',
    url: 'https://investidor10.com.br/acoes/rankings/maiores-crescimento-lucro/',
    pageNeedles: ['maior crescimento de lucro', 'maiores crescimento de lucro', 'maiores crescimentos de lucro'],
    primaryKey: 'profitGrowth5y', primaryLabel: 'Cresc. lucro 5 anos', primaryAliases: ['cresc lucro 5 anos', 'crescimento lucro 5 anos', 'crescimento de lucro 5 anos'],
    displayMetrics: ['profitGrowth5y', 'revenueGrowth5y', 'roe', 'pl', 'netMargin', 'marketCap'],
  }),
  STOCK_REVENUE_GROWTH_5Y: Object.freeze({
    id: 'STOCK_REVENUE_GROWTH_5Y', assetType: 'ACAO', title: 'Maior crescimento de receita',
    subtitle: 'Ações com maior crescimento de receita no horizonte de 5 anos.',
    url: 'https://investidor10.com.br/acoes/rankings/maiores-crescimento-receita/',
    pageNeedles: ['maior crescimento de receita', 'maiores crescimento de receita', 'maiores crescimentos de receita'],
    primaryKey: 'revenueGrowth5y', primaryLabel: 'Cresc. receita 5 anos', primaryAliases: ['cresc receita 5 anos', 'crescimento receita 5 anos', 'crescimento de receita 5 anos'],
    displayMetrics: ['revenueGrowth5y', 'profitGrowth5y', 'roe', 'netMargin', 'pl', 'marketCap'],
  }),
...
const FIELD_ALIASES = Object.freeze({
  ...
  revenue: ['receita', 'receita liquida'],
  netIncome: ['lucro', 'lucro liquido'],
  cash: ['caixas', 'caixa', 'caixa e equivalentes'],
  profitGrowth5y: ['cresc lucro 5 anos', 'crescimento lucro 5 anos', 'crescimento de lucro 5 anos'],
  revenueGrowth5y: ['cresc receita 5 anos', 'crescimento receita 5 anos', 'crescimento de receita 5 anos'],
  ...
  variation30d: ['variacao 30d', 'variacao 30 dias'],
...
function chooseSemanticTable(html = '', definition) {
  const candidates = extractBlocks(html, 'table').map(table => {
    ...
    const assetIndex = meta.map.asset ?? (meta.headers.findIndex(header => normalizeText(header).includes('ativos')));
    const rowCount = extractRows(table).length - 1;
    const hasPrimaryPositionFallback = definition.primaryKey !== 'rank'
      && hasAsset
      && assetIndex >= 0
      && meta.headers.length > assetIndex + 1
      && rowCount > 0;
    const metricCount = Object.keys(meta.map).length;
    return {
      table,
      meta,
      score: (hasAsset ? 50 : 0) + (hasPrimary ? 50 : (hasPrimaryPositionFallback ? 20 : 0))
        + metricCount * 2 + Math.min(Math.max(rowCount, 0), 40),
      hasAsset,
      hasPrimary,
      hasPrimaryPositionFallback,
    };
  }).filter(item => item.hasAsset && (item.hasPrimary || item.hasPrimaryPositionFallback));
...
function parseSemanticRankingHtml(html = '', rankingId = '', limit = DEFAULT_LIMIT) {
  ...
  for (const row of dataRows) {
    ...
    // Ranking pages from Investidor10 consistently place the ranking metric immediately after
    // the asset column. Responsive/header markup occasionally changes enough that the textual
    // header is not recognized even though the data column is still present. In that case,
    // recover only the *primary* metric from column 1; secondary metrics remain semantic-only.
    if (definition.primaryKey !== 'rank' && !displays[definition.primaryKey]) {
      const fallbackPrimaryIndex = assetIndex === 0 ? 1 : (assetIndex + 1);
      const fallbackPrimaryDisplay = rowCellDisplay(cells, fallbackPrimaryIndex);
      if (fallbackPrimaryDisplay) displays[definition.primaryKey] = fallbackPrimaryDisplay;
    }
    const values = {};
    ...
    items.push({
      ...
      revenueDisplay: displays.revenue || undefined,
      netIncome: values.netIncome ?? undefined,
      netIncomeDisplay: displays.netIncome || undefined,
      cash: values.cash ?? undefined,
      cashDisplay: displays.cash || undefined,
      profitGrowth5y: values.profitGrowth5y ?? undefined,
      profitGrowth5yDisplay: displays.profitGrowth5y || undefined,
      revenueGrowth5y: values.revenueGrowth5y ?? undefined,
      revenueGrowth5yDisplay: displays.revenueGrowth5y || undefined,
      ...
      variation30d: values.variation30d ?? undefined,
      variation30dDisplay: displays.variation30d || undefined,
