...
export function buildInvestidor10CanonicalCharts({ ticker = '', type = '', html = '', apiExtras = {} } = {}) {
  ...
  const fundamentalIndicatorHistory = firstNonEmpty([
    ...collectionValues({ historicoIndicadoresFii: apiExtras.historicoIndicadoresFii, rawHistoricoIndicadores: rawJson.historicoIndicadores, rawIndicatorHistory: rawJson.indicatorHistory, rawHistoricalIndicators: rawJson.historicalIndicators }).filter(x => x.value),
  ...
  return {
    ...
    company: type !== 'FII' ? { info, fundamentalIndicatorHistory, dividendHistory: canonicalDividendHistory, dividendMonthly: htmlDividendAggregates.monthly, dividendYearly: htmlDividendAggregates.yearly, dividendYieldHistory: canonicalDividendYieldHistory } : undefined,
    sourceDiagnostics: {
