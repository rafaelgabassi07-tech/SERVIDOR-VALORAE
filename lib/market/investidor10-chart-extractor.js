...
export const VALORAE_I10_CHART_EXTRACTOR_VERSION = '21.12.70-asset-financial-charts-deep-fix';
...
export function buildInvestidor10CanonicalCharts({ ticker = '', type = '', html = '', apiExtras = {} } = {}) {
  ...
  return {
    ...
    financial,
    revenueGeography: apiExtras.embedded?.revenueGeography || null,
    revenueSegment: apiExtras.embedded?.revenueSegment || null,
    revenueByRegion: apiExtras.embedded?.revenueGeography || null,
    revenueByBusiness: apiExtras.embedded?.revenueSegment || null,
    revenueBreakdowns: {
      geography: apiExtras.embedded?.revenueGeography || null,
      region: apiExtras.embedded?.revenueGeography || null,
      byRegion: apiExtras.embedded?.revenueGeography || null,
      business: apiExtras.embedded?.revenueSegment || null,
      byBusiness: apiExtras.embedded?.revenueSegment || null,
