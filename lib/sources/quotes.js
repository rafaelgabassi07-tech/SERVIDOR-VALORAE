...
export async function buildAssetsPayload(payload = {}) {
  ...
  const includeFundamentals = booleanOption(payload.includeFundamentals, true);
  const bypassCache = booleanOption(payload.refresh, false) || booleanOption(payload.nocache, false) || booleanOption(payload.forceRefresh, false);
