...
import { fetchInvestidor10AnalysisRanking, getInvestidor10AnalysisRankingCatalog } from '../../market/analysis-rankings-i10.js';
...
export const investidor10SourceAdapter = registerSourceAdapter({
  ...
  operations: {
    ...
    analysisRanking: fetchInvestidor10AnalysisRanking,
    analysisRankingCatalog: getInvestidor10AnalysisRankingCatalog,
  },
});
