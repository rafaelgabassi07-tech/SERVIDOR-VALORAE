...
export const fetchInvestidor10AnalysisRanking = (...args) => executeSourceAdapter('investidor10', 'analysisRanking', args);
export const getInvestidor10AnalysisRankingCatalog = (...args) => executeSourceAdapter('investidor10', 'analysisRankingCatalog', args);
