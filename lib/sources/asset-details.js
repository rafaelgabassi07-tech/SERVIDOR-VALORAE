...
function extractInvestidor10EmbeddedAnalysisData(html = '', pageUrl = 'https://investidor10.com.br/') {
...
async function fetchInvestidor10AnalysisExtras(ticker, type, html = '', options = {}) {
  ...
  const embedded = extractInvestidor10EmbeddedAnalysisData(html, options.pageUrl || `https://investidor10.com.br/${type === 'fii' ? 'fiis' : 'acoes'}/${clean.toLowerCase()}/`);
