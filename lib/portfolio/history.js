...
export const PORTFOLIO_HISTORY_VERSION = '21.12.324-modal-deadline-disable-external-v295';
...
export async function buildPortfolioHistory(positions, options = {}) {
  ...
  const currentPositions = activePositions.length ? activePositions : normalized.filter(p => p.quantity > 0);
