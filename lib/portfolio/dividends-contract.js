...
function buildDividendResult({
  ...
  const enriched = eventsWithinRequestedWindow(officialEvents.map(e => enrichPortfolio(e, payload)), payload);
  ...
  const portfolioUpcoming = split.upcoming.filter(e => e.eligible);
