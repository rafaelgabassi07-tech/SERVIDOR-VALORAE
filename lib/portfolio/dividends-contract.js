  ...
  return coalesce(cacheKey, async () => {
    ...
    diagnostics.push({
      ...
      sourcePolicy: recoveryMode
        ? 'Recuperacao mobile v2: pagina publica visivel do StatusInvest prioritaria por ativo; endpoint JSON interno como contingencia; calendario publico pesado desativado.'
