...
function dividendValuesEquivalent(a = {}, b = {}, toleranceRatio = 0.02) {
  const left = Number(a.grossValuePerShare || a.declaredValuePerShare || a.netValuePerShare || a.valuePerShare || a.amount || a.value || 0);
  const right = Number(b.grossValuePerShare || b.declaredValuePerShare || b.netValuePerShare || b.valuePerShare || b.amount || b.value || 0);
...
function sameEconomicAnnouncement(a = {}, b = {}) {
  ...
  const crossProviderFii = isFiiLikeDividendEvent(a) && isFiiLikeDividendEvent(b) && providerA && providerB && providerA !== providerB;
