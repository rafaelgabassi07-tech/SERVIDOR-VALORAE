...
export function benchmarkExposureAlignedMonthMap(
  ...
  for (const row of portfolio) {
    ...
    if (segmentChanged) {
      ...
      // denominator. Skip only that partial observation. The close of that month is a legitimate
      // baseline for the next *full* invested month, so the comparison must resume there instead
      // of disabling every benchmark for the rest of the exposure cycle.
