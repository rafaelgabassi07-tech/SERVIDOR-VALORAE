...
export const ERROR_CATALOG = Object.freeze([
  ...
  { code: 'VALORAE_APK_REQUEST_REQUIRED', http: 403, retryable: false, description: 'Requisição sem a identidade canônica do APK VALORAE.' },
...
export const ENV_CATALOG = Object.freeze([
  ...
  { name: 'VALORAE_CORS_STRICT', required: false, category: 'security', defaultValue: '1 em produção', example: '1', description: 'Usa allowlist/base pública em vez de wildcard; produção já opera em modo estrito.' },
