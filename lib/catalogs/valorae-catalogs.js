export const VALORAE_CATALOG_VERSION = '21.11.3';
...
export const SCHEMA_CATALOG = Object.freeze({
  asset: { version: 'asset-v21.11.3', required: ['version','ticker','type','status','results','normalized','quality','sourceReport'], volatile: ['requestId','generatedAt','checkedAt'], description: 'Contrato de ativo com dados brutos, normalizados, qualidade e fontes.' },
  portfolio: { version: 'portfolio-v21.11.3', required: ['summary','positions','allocation','income','risk','intelligence'], volatile: ['requestId','generatedAt'], description: 'Contrato de carteira com inteligência, concentração, renda, risco e planos.' },
