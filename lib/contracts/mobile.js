...
export async function buildMobilePortfolioSync(payload = {}) {
  ...
  const dividendDeadlineMs = Number(payload.dividendsDeadlineMs || payload.routeDeadlineMs || (normalizedPayload.mode === 'deep-background' ? 18500 : 12000));
