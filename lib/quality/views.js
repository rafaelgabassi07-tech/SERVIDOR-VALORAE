  ...
  payload.payloadViewProfile = {
    ...
    notes: payload.view === 'compact'
      ...
      : payload.view === 'standard'
        ...
        : payload.view === 'app'
          ? ['app entrega appMobileSnapshot/appPayload como raízes oficiais e espelha normalized/results compatíveis para o APK VALORAE']
          : ['full preserva payload completo'],
    legacyMirroredRoots: payload.legacyAppCompat?.mirroredRoots || [],
  };
  return payload;
}
