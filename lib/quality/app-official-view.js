...
export function buildOfficialAppView(payload = {}) {
  ...
  const output = {
    ...
    legacyAppCompat: {
      ...
      reason: 'APK VALORAE consome raízes canônicas oficiais e compatibilidade compacta ainda ativa.'
    },
    ...
    appContract: {
      stableRootOrder: ['assetChartBundle', 'appMobileSnapshot', 'appPayload', 'news', 'newsStatus', 'appSyncEnvelope', 'appResponseIntegrity', 'assetActionPlan', 'engineLaunchGate', 'fieldConsistencyGuard', 'payloadBudget', 'assetIndicatorCoverage', 'engineMaturityBooster', 'engineRuntimeProfiler', 'dataReliability'],
