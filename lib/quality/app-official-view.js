...
export function buildOfficialAppView(payload = {}) {
  ...
  const output = {
    ...
    appContract: {
      stableRootOrder: ['appMobileSnapshot', 'appPayload', 'news', 'newsStatus', 'appSyncEnvelope', 'appResponseIntegrity', 'assetActionPlan', 'engineLaunchGate', 'fieldConsistencyGuard', 'payloadBudget', 'assetIndicatorCoverage', 'engineMaturityBooster', 'engineRuntimeProfiler', 'dataReliability'],
