...
export function buildOfficialAppView(payload = {}) {
  ...
  const output = {
    ...
    appContract: {
      stableRootOrder: ['appMobileSnapshot', 'appPayload', 'appSyncEnvelope', 'appResponseIntegrity', 'assetActionPlan', 'engineLaunchGate', 'fieldConsistencyGuard', 'payloadBudget', 'assetIndicatorCoverage', 'engineMaturityBooster', 'engineRuntimeProfiler'],
