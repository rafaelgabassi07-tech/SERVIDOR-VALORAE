...
function buildRevenueBreakdowns(payload = {}) {
  ...
  return {
    revenueGeography: charts.revenueGeography || charts.regioesReceita || charts.revenueByRegion || null,
    regioesReceita: charts.regioesReceita || charts.revenueGeography || charts.revenueByRegion || null,
    revenueByRegion: charts.revenueByRegion || charts.revenueGeography || charts.regioesReceita || null,
    revenueSegment: charts.revenueSegment || charts.revenueByBusiness || charts.negociosReceita || null,
    revenueByBusiness: charts.revenueByBusiness || charts.revenueSegment || charts.negociosReceita || null,
    negociosReceita: charts.negociosReceita || charts.revenueByBusiness || charts.revenueSegment || null,
    segmentosReceita: charts.segmentosReceita || charts.revenueByBusiness || charts.revenueSegment || null,
