...
export const VALORAE_EXTRACTION_PRECISION_VERSION = '21.12.52-extraction-precision-capped-coverage';
...
export function buildExtractionPrecisionReport({ results = {}, selectors = {}, htmlLength = 0, strategy = 'unknown', warnings = [], sourceDrift = null } = {}) {
  ...
  const coverageRatio = expected ? Math.round((matchedKeys.length / expected) * 10000) / 10000 : 1;
