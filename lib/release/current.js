...
export const VALORAE_PUBLIC_VERSION = '21.12.87';
export const VALORAE_RELEASE_PATCH = '21.12.87-agenda-proventos-retroactive-cleanup';
export const VALORAE_RELEASE_LABEL = 'agenda-proventos-retroactive-cleanup';
