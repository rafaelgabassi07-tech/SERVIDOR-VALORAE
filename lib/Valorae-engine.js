...
export const VALORAE_ENGINE_VERSION = '21.11.3';
...
function buildEngineCoreStats() {
  ...
  return {
    version: '21.11.3-engine-core-performance-precision',
    score,
...
export class ValoraeEngine {
  ...
  static async _fetchAtivoUncached(rawTicker, rawType, options = {}) {
    ...
    payload.chartReadiness = buildChartReadinessReport({ ...(payload.results || {}), ...(payload.results?.sections || {}) });
