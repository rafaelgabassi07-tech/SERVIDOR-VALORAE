...
export class ValoraeEngine {
  ...
  static async _fetchAtivoUncached(rawTicker, rawType, options = {}) {
    ...
    runtimeProfiler.end(stageToken, { urlsTried: primaryUrls.length, parsed: Boolean(parse), source: htmlFetch?.hostname || null });
    ...
    runtimeProfiler.end(stageToken, { keys: Object.keys(results || {}).filter(k => k !== 'sections').length });
