...
export function sharedStateMode() {
  // A sincronização financeira mínima isola o Supabase dos mecanismos operacionais do
  // Proxy. Circuit breakers, leases, cache negativo e continuidade permanecem sempre
  // em memória da instância, mesmo se variáveis antigas solicitarem modo remoto.
  return boolValue(process.env.VALORAE_SHARED_STATE_ENABLED, true) ? 'memory' : 'off';
}
