...
export const VALORAE_DYNAMIC_RENDER_IMPLEMENTATION = 'playwright-core-optional-budgeted-isolated-browser-reuse-v2';
  ...
  return {
    ...
    async render(url, options = {}) {
      ...
      try {
        ...
        return { html, finalUrl, status: response?.status?.() || 200, runtime: 'playwright-core', waitStrategy, browserReused: pooled && state.browserPool.uses > 1 };
      } catch (error) {
        failed = true;
        throw error;
      } finally {
...
export function resetDynamicRenderStateForTests() {
  ...
  Object.assign(state.metrics, {
    ...
    explicitSelectorWaits: 0, networkIdleWaits: 0,
  });
}
