...
export const VALORAE_SERVER_METRICS_VERSION = '21.12.51-post-benchmark-performance-hardening-monitor';
...
export function getServerMetricsSnapshot() {
  ...
  return {
    ...
    version: VALORAE_SERVER_METRICS_VERSION,
    releasePatch: '21.12.51-post-benchmark-performance-hardening',
