...
function buildMonitorBlueprint(summary = {}, routeDetails = [], payloadIntelligence = {}, vercelRuntime = {}) {
  ...
  return {
    ...
    technologies: [
      { name: 'Node.js 20', layer: 'Runtime', role: 'Executa rotas serverless e normalização JSON sem servidor dedicado.' },
    ...
    securityControls: [
      ...
      'Sem dependência de banco externo, Redis, KV ou segredo obrigatório para leitura pública do monitor.',
    ],
    resilienceControls: [
