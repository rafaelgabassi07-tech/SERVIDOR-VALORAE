...
export const VALORAE_SERVER_METRICS_VERSION = '21.12.69-valorae-asset-charts-performance-web-index-monitor';
...
export function getServerMetricsSnapshot() {
  ...
  return {
    ...
    version: VALORAE_SERVER_METRICS_VERSION,
    releasePatch: '21.12.69-valorae-asset-charts-performance-web-index',
