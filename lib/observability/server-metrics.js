...
export const VALORAE_SERVER_METRICS_VERSION = '21.12.68-valorae-i10-asset-charts-end-to-end-fix-monitor';
...
export function getServerMetricsSnapshot() {
  ...
  return {
    ...
    version: VALORAE_SERVER_METRICS_VERSION,
    releasePatch: '21.12.68-valorae-i10-asset-charts-end-to-end-fix',
