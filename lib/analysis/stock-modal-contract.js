...
function normalizeStockHistoricalIndicatorsDataset(data, options = {}) {
  ...
  if (!rows.length) {
    const candidateKeys = ['historicoIndicadores','historico_indicadores','historico_indicadores_fundamentalistas','historico','historics','historicIndicators','historic_indicators','indicadoresHistoricos','indicadores_historicos','historyIndicators','indicators_history','indicator_history','historicalIndicators','historical_indicators','indicatorHistory','fundamentalHistory','fundamentalsHistory','fundamentalIndicatorHistory','fundamental_indicator_history','fundamentals','fundamental','ratios','ratioHistory','indicadores','indicators','metrics','metricas','table','tabela','chart','chartData','payload','data','result','response','results'];
...
function buildStockHistoricalIndicatorSources({ html = '', ticker = '', apiExtras = {} } = {}) {
  ...
  for (const key of ['historicalIndicators','historicoIndicadores','historicIndicators','indicadoresHistoricos','indicatorHistory','fundamentalIndicatorHistory']) {
