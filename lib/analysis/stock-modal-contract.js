...
export const STOCK_MODAL_VERSION = '26.asset-modal.stock.v19';
...
async function buildStockIndexComparison(ticker, timeoutMs = 8500) {
  ...
  return {
    ...
    sourcePolicy: 'Comparação de ações com índices usa o mesmo formato do modal de FIIs. O ativo, IBOV, IVVB11, IFIX, SMLL e IDIV usam Yahoo Finance Chart API; IFIX.SA, SMLL.SA e IDIV.SA são consultados diretamente. CDI e IPCA usam Banco Central SGS.'
  };
}
...
function extractInvestidor10StockPeerComparison(html = '', ticker = '', quickMetrics = {}, fundamentalIndicators = {}) {
  ...
  return {
    ...
    diagnostics: { parsedRows: rows.length, policy: 'no_static_substitution' }
  };
}
