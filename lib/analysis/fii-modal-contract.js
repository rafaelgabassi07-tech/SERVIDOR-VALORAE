...
function extractInvestidor10FiiChecklistMarkup(html = '', ticker = '') {
  ...
  for (const match of section.matchAll(itemPattern)) {
    ...
    const labelText = cleanInvestidor10InfoValue(labelHtml);
