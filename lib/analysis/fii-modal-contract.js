...
const FII_MODAL_VERSION = '26.asset-modal.fii.v21';
...
function ensureFiiBuyHoldChecklist({ checklist = null, ticker = '', html = '', quickMetrics = {}, infoItems = [], propertyPortfolio = null, vacancyHistory = null, patrimonialInfo = null, dividendCharts = null } = {}) {
  ...
  return {
    ...
    diagnostics: {
      ...
      derivation: 'fallback_from_investidor10_modal_metrics',
      listedYear,
      yearsListed,
...
async function fetchInvestidor10FiiBundle(ticker, timeoutMs = 6500) {
  ...
  const announcements = await enrichInvestidor10FiiAnnouncementPdfLinks(mergeFiiAnnouncementsPayloads(mainAnnouncements, directAnnouncements), { timeoutMs });
  return {
    ok: Boolean(html),
    url,
