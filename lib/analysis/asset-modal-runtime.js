...
export const ASSET_MODAL_RUNTIME_VERSION = '26.asset-modal.runtime.v13-protocol-negotiation';
...
function buildModalDelivery(payload = {}, runtime = {}) {
  ...
  const isFinal = deliveredStage === 'full' && !deadlineTimeout && !explicitlyPartial && quality.completeForDelivery;
  return {
    schemaVersion: '2',
    ...
    retryable: deadlineTimeout || explicitlyPartial || !quality.completeForDelivery,
    qualityTier: quality.qualityTier,
    stableForCache: quality.stableForCache,
    completeForDelivery: quality.completeForDelivery,
