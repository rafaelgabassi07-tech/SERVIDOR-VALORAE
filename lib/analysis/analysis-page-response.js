...
function buildAssetCharts(payload = {}) {
  ...
  const price = analysisChart('price_history', 'Cotação em tempo real', 'line', priceRows, 'Yahoo Finance Chart API + quote em tempo real', { valueKeys: ['close', 'price', 'value'], minPoints: 2, limit: 24, unit: 'R$', seriesLabel: 'Cotação', sourceFidelity: 'derived' });
  ...
  const revenueProfit = multiSeriesChart('revenue_profit', 'Receitas e Lucros', 'grouped_bar', revenueRows, 'StatusInvest/Investidor10/Yahoo fundamentals', [
    ...
    dualSeriesChart('revenue_profit', 'Receitas e Lucros', 'grouped_bar', revenueRows, 'StatusInvest/Yahoo fundamentals', { id: 'revenue', label: 'Receita', valueKeys: ['netRevenue', 'revenue', 'receita'] }, { id: 'profit', label: 'Lucro', valueKeys: ['netProfit', 'profit', 'lucro'] });
  ...
  const equity = isFii
    ? analysisChart('fii_patrimonial_value', 'Valor patrimonial', 'bar', equityRows, 'StatusInvest/Investidor10', { valueKeys: ['netWorth', 'equity', 'patrimonioLiquido', 'valorPatrimonial', 'patrimonialValue', 'value'], minPoints: 2, limit: 12, unit: 'R$' })
    : (multiSeriesChart('equity_evolution', 'Balanço e patrimônio', 'grouped_bar', equityRows, 'StatusInvest/Investidor10/Yahoo fundamentals', [
      ...
      analysisChart('equity_evolution', 'Evolução patrimonial', 'bar', equityRows, 'StatusInvest/Yahoo fundamentals', { valueKeys: ['netWorth', 'equity', 'patrimonioLiquido', 'value'], minPoints: 2, limit: 12 }));
...
const SOURCE_SECTION_REFERENCE_LABELS = {
  ...
  asset_charts: 'Cotação, receitas/lucros, lucro x cotação, DY e patrimônio',
