...
export const ANALYSIS_SURFACES = [
  ...
  },
  {
    ...
    defaultExpandedSectionIds: ['asset_charts', 'summary', 'fundamental_indicators', 'company_profile', 'dividends_history', 'historical_indicators', 'revenue_breakdown', 'dividends_summary'],
  },
  {
