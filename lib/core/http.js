...
export function sendJson(req, res, payload, options = {}) {
  ...
  res.setHeader('X-Valorae-Extraction-Intelligence', VALORAE_EXTRACTION_INTELLIGENCE_VERSION);
  ...
  res.setHeader('X-Valorae-Scraping-Engine', VALORAE_HYBRID_DOCUMENT_VERSION);
  ...
  const responseBytes = notModified || isHead ? 0 : bodyBytes;
