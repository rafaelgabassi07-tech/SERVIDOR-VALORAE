...
export const VALORAE_EXPOSE_HEADERS = Object.freeze([
  ...
  'X-Valorae-Auth-Mode',
  'X-Valorae-Apk-Compatibility',
  'X-Valorae-Paired-Apk-Version',
  'X-Valorae-Min-Apk-Version',
  'X-Valorae-Max-Tested-Apk-Version',
  'X-Valorae-Paired-Source-Fingerprint',
  'X-Valorae-Source-Fingerprint-Status',
  'X-Valorae-App-Id',
  'X-Valorae-Security',
  'X-RateLimit-Limit',
