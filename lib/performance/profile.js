...
export const VALORAE_PERFORMANCE_VERSION = '21.12.69-chartfast-mobile-performance';
...
export function performanceCapabilities() {
  return {
    ...
    queryParams: ['profile=instant|ultra|tiny|quote|card|chartfast|wallet|analysis|fast|standard|turbo|deep|portfolio', 'view=instant|ultra|tiny|quote|card|wallet|detail|analysis|compact|standard|full', 'complete=1', 'adaptiveCompletion=1|0', 'hedgedStatusInvest=1|0', 'dedupeBatch=1|0', 'staleWhileRevalidate=1|0', 'nocache=1', 'debug=1', 'contracts=full|lite|auto']
  };
}
