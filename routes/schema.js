...
export default async function handler(req, res) {
  ...
  return sendJson(req, res, { version: ValoraeEngine.version, requestId: route.requestId, status: 'OK', ...schemaCatalog() }, { status: 200, engineVersion: ValoraeEngine.version, profile: 'schema', schemaVersion: 'schema-catalog-v21.11.8', cachePolicy: 'etag', cacheControl: TTL_MATRIX.staticCatalog.cacheControl });
}
