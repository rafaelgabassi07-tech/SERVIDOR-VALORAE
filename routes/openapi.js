...
const assetParams = [
  ...
  qp('view', { type: 'string', enum: ['instant','ultra','tiny','quote','card','mobile','snapshot','sync','wallet','portfolio','watchlist','list','detail','analysis','compact','standard','full'] }, 'Nível de payload; aliases são resolvidos internamente.'),
  ...
  return sendJson(req, res, {
    ...
    components: {
      schemas: {
        ...
        AssetPayload: { type: 'object', properties: { version: { type: 'string' }, schemaVersion: { type: 'string' }, status: { type: 'string', enum: ['OK','PARTIAL','ERROR'] }, ticker: { type: 'string' }, type: { type: 'string' }, results: { type: 'object' }, normalized: { type: 'object', additionalProperties: { $ref: '#/components/schemas/FinancialField' } }, chartSeries: { type: 'object' }, panelReadiness: { type: 'object' }, consumerDiagnostics: { type: 'object' }, appPayload: { type: 'object' }, appRenderContract: { type: 'object' }, appDataContract: { type: 'object' }, appSyncEnvelope: { type: 'object' }, appMobileSnapshot: { type: 'object' }, appResponseIntegrity: { type: 'object' }, payloadViewProfile: { type: 'object' }, quality: { type: 'object' }, parserResilience: { type: 'object' } } },
    ...
    xValorae: {
      version,
      audit: 'v21.12.0: launch readiness, ready/manifest endpoints, auditoria sem tsc externo, source reliability, cache metrics, carteira inteligente e OpenAPI ampliado, mantendo free-only.',
