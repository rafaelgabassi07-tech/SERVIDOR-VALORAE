...
const paths = {
  ...
  '/api/v1/market/rankings': { get: op('Rankings de ações/FIIs com Home do Investidor10 como fonte canônica para Maiores Altas/Baixas e captura completa', [qp('type', { type: 'string', enum: ['ACAO','FII'], default: 'ACAO' }), qp('source', { type: 'string', enum: ['auto','home','live','compare','dedicated','pages'], default: 'auto' }), qp('mode', { type: 'string', enum: ['auto','complete'], default: 'auto' }), qp('strict', { type: 'boolean', default: false }), qp('limit', { type: 'integer', default: 15 }), qp('minRows', { type: 'integer', default: 6 }), qp('maxItems', { type: 'integer', default: 20 })], undefined, ['Market']) },
  ...
  '/api/sync': { get: op('Sincronização financeira mínima: health, diagnostics, auth_check e status', [], undefined, ['Sync']), post: op('Sincronização financeira mínima: download_financial_data, upload_transactions, upload_dividends e delete_financial_data', [], postJsonBody, ['Sync']) },
};
  ...
  return sendJson(req, res, {
    ...
    components: {
      schemas: {
        ...
        AssetPayload: { type: 'object', properties: { version: { type: 'string' }, schemaVersion: { type: 'string' }, status: { type: 'string', enum: ['OK','PARTIAL','ERROR'] }, ticker: { type: 'string' }, type: { type: 'string' }, results: { type: 'object' }, normalized: { type: 'object', additionalProperties: { $ref: '#/components/schemas/FinancialField' } }, chartSeries: { type: 'object' }, panelReadiness: { type: 'object' }, consumerDiagnostics: { type: 'object' }, appPayload: { type: 'object' }, appRenderContract: { type: 'object' }, appDataContract: { type: 'object' }, appSyncEnvelope: { type: 'object' }, appMobileSnapshot: { type: 'object' }, contractBaseline: { type: 'object' }, fieldObservability: { type: 'object' }, appResponseIntegrity: { type: 'object' }, engineEfficiency: { type: 'object' }, engineMaturityBooster: { type: 'object' }, fieldConsistencyGuard: { type: 'object' }, payloadBudget: { type: 'object' }, assetActionPlan: { type: 'object' }, engineRuntimeProfiler: { type: 'object' }, engineLaunchGate: { type: 'object' }, assetClassContract: { type: 'object' }, assetIndicatorCoverage: { type: 'object' }, engineModuleTree: { type: 'object' }, payloadViewProfile: { type: 'object' }, quality: { type: 'object' }, parserResilience: { type: 'object' } } },
