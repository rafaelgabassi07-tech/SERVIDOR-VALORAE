...
const paths = {
  ...
  '/api/sync': { get: op('Sincronização Supabase Auth: health, get_snapshot, get_transactions e get_dividend_events', [], undefined, ['Sync']), post: op('Sincronização Supabase Auth: upsert_snapshot, upsert_transactions, upsert_dividend_events e delete_user_data', [], postJsonBody, ['Sync']) },
};
