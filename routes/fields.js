...
const stableAssetFields = [
  ...
  { path: 'contractBaseline', type: 'object', description: 'Baseline versionado e decisão de continuidade para impedir perda de campos previamente válidos.' },
  { path: 'contractBaseline.canReplacePrevious', type: 'boolean', description: 'Indica se o APK pode substituir o último payload compatível por esta resposta.' },
  { path: 'fieldObservability', type: 'object', description: 'Envelope diagnóstico compacto e oculto da UI com origem, método, confiança, fallback e tempos por campo.' },
  { path: 'fieldObservability.traceId', type: 'string', description: 'Identificador para consultar temporariamente a trilha completa em /api/v1/contract/observability.' },
